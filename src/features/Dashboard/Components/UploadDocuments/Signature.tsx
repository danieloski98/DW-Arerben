...
export default function Signature() {
    ...
    return (
        <View style={{ flex: 1, paddingTop: 20 }}>
            <Text style={style.headerText}>Attach Your Signture</Text>
            <Text style={style.normalText}>Please sign on a white paper and upload your signature to affirm your application</Text>
            {
                pic !== "" && 
