...
export default function ValidIDCard() {
    ...
    return (
        <View style={{ flex: 1, paddingTop: 20 }}>
            <Text style={style.headerText}>Valid Identity card</Text>
            <Text style={style.normalText}>Please upload the document you selected when filling your profile information.</Text>
            {
                pic !== "" && 
