...
export default function LinkCard() {
    return (
        <View style={{ flex: 1,  }}>
            <Text style={{ fontSize: Theme.header - 4, fontWeight: '500'}}>Share your referral link</Text>
            ...
            <View style={{ flex: 0.5, marginTop: 20, height: '30%'}}>
                <View style={{ width: '100%', backgroundColor: '#FFEBE2', height: '100%', borderRadius: 10, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 10}}>
