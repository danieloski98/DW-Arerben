...
export default function SuccessModal(props: { visible: boolean, close: Function }) {
  return (
    <Modal visible={props.visible}  transparent>
      <View style={{ width: '100%', height: '100%', backgroundColor: 'rgba(0, 0, 0, 0.603)', justifyContent: 'center', paddingHorizontal: 20}}>
        <View style={{ width: '100%', borderRadius: 10, backgroundColor: 'white', height: '40%', alignItems: 'center', justifyContent: 'center', padding: 20 }}>
            <Feather name="thumbs-up" color={Theme.primaryColor} size={60} />

            <Text style={style.headerText}>Your investment request submission was successful!</Text>
            <Text style={style.normalText}>You will be notified when your payments verified and approved</Text>
